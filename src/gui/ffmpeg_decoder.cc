...
ffmpeg::SDecoder::SDecoder(const char *source, const char *sourceType,
    const char *options, ffmpeg::DXVA dxva)
    : m_FormatCtx{ffmpeg::openSource(source, sourceType, options)}
